...
#let make-cover-zh(config) = {
  set text(font: font-family.HeiTi)
  // 论文标题
  align(center, text(size: 26pt)[#config.cover.zh.title])
  v(1.5em)
  // 校徽
  align(center + top, image("/assets/school-badge-black.png", width: 20%))
  v(1.5em)

  let banner = "重庆大学本科毕业论文"
  if config.degree=="bachelor"{
    banner = "重庆大学硕士学位论文"
  }
  align(center, text(size: 26pt)[#banner])
